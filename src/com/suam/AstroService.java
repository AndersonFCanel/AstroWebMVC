...
public class AstroService {
	...
	public AstroService(PessoaBean pessoa) {
		super();
		this.pessoa = pessoa;
	}
	...
	public float calculaDias() {
		dia = (float) (pessoa.getIdade() * 365.25f);
		return dia;
	}

	public int calculaMeses() {
		meses = (pessoa.getIdade() * 12);
		return meses;
	}
	...
	public long calculaMinutos() {
		minuto = (long) (pessoa.getIdade() * 365.25 * 60 * 24);
		return minuto;
	}

	public long calculaSegundos() {
		segundo = (long) (pessoa.getIdade() * 365.25 * 60 * 60 * 24);
		return segundo;
	}
